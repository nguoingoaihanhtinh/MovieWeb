...
const Filter = ({ onFilterChange }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center gap-4 mb-8">
      <FilterSection label="Loại phim" options={movieTypes} name="movieType" onChange={handleFilterChange} />
      <FilterSection label="Thể loại" options={genres} name="genre" onChange={handleFilterChange} />
      <FilterSection label="Quốc gia" options={countries} name="country" onChange={handleFilterChange} />
      <FilterSection label="Năm" options={years} name="year" onChange={handleFilterChange} />
